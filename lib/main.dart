...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //default is cs
  final List<String> _defaultPlayListIds = [
    '7U2M8MbHo5I',
    '9hXuAA0OGQo',
    'oqIsckPywdw',
    '4zKl7X4kKwo',
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.push(
              context,
              CupertinoPageRoute(builder: (context) => VideoList(_historyIds)),
            ),
          ),
        ],
      ),
      body: ListView(
        children: [
          YoutubePlayer(
            ...
            onEnded: (id) {
              _streamVideo(_defaultPlayListIds[count++]);
        ...
        onPressed: _isPlayerReady
            ? () {
                if (_idController.text.isNotEmpty) {
                  ...
                  if (action == 'LOAD') _streamVideo(id);
